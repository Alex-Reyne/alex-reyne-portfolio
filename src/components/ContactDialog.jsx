  ...
  return (
    ...
    >
      ...
      <DialogContent className="fade-in">
        ...
        <DialogContentText id="alert-dialog-description">306.821.3553</DialogContentText>
        <DialogContentText id="alert-dialog-description">creativereyne@gmail.com</DialogContentText>
      </DialogContent>
